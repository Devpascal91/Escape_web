...
function perdu() {
  ...
  // affichage des vies
  // const vieballe = document.querySelectorAll('vie');
  // for (let v = 3; v < 'vie'; v--) {
  //   const buttons = vie[v].addEventListener("click",function(){
  //   const vieballe = v [Math.floor](Math.random).innerhtml;
  //   console.log(`vieballe: ${vieballe});
  //   }
  // }
