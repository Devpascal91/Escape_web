...
!function (e) {
     ...
     var r = !/Edge|Trident/.test(navigator.userAgent),
       ...
       i = function () {
         var e = 9,
           ...
           r = function (e) {
             e = e.replace(o, "$1");
             for (var t = [0, 0, 0], n = 0, r = 0; n < e.length; n++) r = parseInt(n / t.length), t[n % 3] += parseInt(s(e[n]) / i(r));
         ...
         return {
           ...
           toRGB: a,
           visible: function (e) {
             return e[0] > n || e[1] > n || e[2] > n ? [0, 0, 0] : [255, 255, 255]
           }
         }
       }(),
       s = function (e, t, n, a) {
         return o[t] ? function () {
           ...
           r && i.unshift("background-color:" + a + ";color:" + n + ";border-radius:2px;"), i.unshift((r ? "%c" : "") + [" ", e, " "].join("")), o[t].apply(console, i)
         } : function () {}
       },
       c = function () {
         try {
   ...
   function (e) {
     "use strict";
     var t = {
         domains: ["hpphmfubhnbobhfs", "bnb{po.betztufn", "beoyt", "epvcmfdmjdl", "hpphmftzoejdbujpo", "wjefptufq", "s77ofu", "ufbet", "vosvmznfejb", "tnbsubetfswfs", "tljnsftpvsdft", "{fcftupg", "uumce", "hpphmfbqjt", "wjefpqmb{b", "hpphmfbetfswjdft", "fggfdujwfnfbtvsf", "pvucsbjo", "ubcppmb"],
             ...
             t.forEach(function (t) {
               try {
                 if ("childList" === t.type && "HTML" === t.target.nodeName && t.addedNodes.length && "BODY" === t.addedNodes[0].nodeName && !c) {
                   ...
                   if (i = t.addedNodes[0], d.disconnect(), /Trident/.test(navigator.userAgent)) return void setTimeout(function () {
    ...
    dataLayer.push({
      ...
      appConfig: {
        asl: {
          ...
          keywords: ["wild-west-solitaire", "keyword-jeux-classiques", "keyword-jeux-de-patience", "keyword-jeux-de-plateau", "keyword-jeux-mobile-gratuit", "keyword-jeux-de-cartes", "keyword-jeux-de-solitaire", "keyword-jeux-de-cowboy", "keyword-jeux-html-5", "keyword-jeux-de-cartes-html5", "keyword-jeux-de-reflexion"]
        }
      }
    });
 var _v, settings = {
